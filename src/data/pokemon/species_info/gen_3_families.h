...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .abilities = { ABILITY_UNBURDEN, ABILITY_NONE, ABILITY_OVERGROW },
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_NONE, ABILITY_BLAZE },
    ...
    [SPECIES_POOCHYENA] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_QUICK_FEET, ABILITY_RATTLED },
    #else
        .abilities = { ABILITY_GUTS, ABILITY_NONE, ABILITY_RATTLED },
    #endif
    ...
    [SPECIES_MIGHTYENA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GUTS, ABILITY_INTIMIDATE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_ZIGZAGOON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PICKUP, ABILITY_QUICK_FEET, ABILITY_GUTS },
    #else
        .abilities = { ABILITY_PICKUP, ABILITY_NONE, ABILITY_GUTS },
    #endif
    ...
    [SPECIES_WURMPLE] =
    {
        ...
        .abilities = { ABILITY_TECHNICIAN, ABILITY_NONE, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BEAUTIFLY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TINTED_LENS, ABILITY_SWARM, ABILITY_RIVALRY },
    ...
    [SPECIES_DUSTOX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_PRANKSTER, ABILITY_SHIELD_DUST, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .abilities = { ABILITY_CONTRARY, ABILITY_CHLOROPHYLL, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_WINGULL] =
    {
        ...
        .abilities = { ABILITY_DRIZZLE, ABILITY_KEEN_EYE, ABILITY_RAIN_DISH },
    #else
        .abilities = { ABILITY_DRIZZLE, ABILITY_KEEN_EYE, ABILITY_RAIN_DISH },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    #else
        .abilities = { ABILITY_TECHNICIAN, ABILITY_NONE, ABILITY_EFFECT_SPORE },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NINCADA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_COMPOUND_EYES, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_NINJASK] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_INFILTRATOR, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MAKUHITA] =
    {
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_THICK_FAT, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SAND_FORCE, ABILITY_STURDY, ABILITY_MAGNET_PULL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    #else
        .abilities = { ABILITY_PRANKSTER, ABILITY_NONE, ABILITY_STALL },
    #endif
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_MAWILE] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_CONTRARY, ABILITY_INTIMIDATE, ABILITY_SHEER_FORCE },
    ...
    [SPECIES_ARON] =
    {
        ...
        .abilities = { ABILITY_HEAVY_METAL, ABILITY_STURDY, ABILITY_ROCK_HEAD },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Aron"),
        .cryId = CRY_ARON,
    ...
    [SPECIES_PLUSLE] =
    {
        ...
        .abilities = { ABILITY_PLUS, ABILITY_SOLAR_POWER, ABILITY_TECHNICIAN },
    #else
        .abilities = { ABILITY_PLUS, ABILITY_SOLAR_POWER, ABILITY_TECHNICIAN },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_MINUN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_MINUS, ABILITY_UNAWARE },
    #else
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_MINUS, ABILITY_UNAWARE },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ROSELIA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
        .abilities = { ABILITY_TRIAGE, ABILITY_NATURAL_CURE, ABILITY_POISON_POINT },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_CARVANHA] =
    {
        ...
        .abilities = { ABILITY_STRONG_JAW, ABILITY_NONE, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_SHARPEDO}),
    },
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .abilities = { ABILITY_STAMINA, ABILITY_OBLIVIOUS, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ZANGOOSE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SCRAPPY, ABILITY_IMMUNITY, ABILITY_TOXIC_BOOST },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_CORPHISH] =
    {
        ...
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_SHELL_ARMOR, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_LILEEP] =
    {
        ...
        .abilities = { ABILITY_STORM_DRAIN, ABILITY_SUCTION_CUPS, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_CLEAR_BODY, ABILITY_LIGHT_METAL },
        .bodyColor = BODY_COLOR_BLUE,
