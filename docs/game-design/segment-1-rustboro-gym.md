...
**Badge:** Stone Badge
**Reward:** TM71 Rock Tomb
**Strategy:** Sandstorm team — Larvitar sets Sand Stream on entry
...
- White Herb (Pretty Petal Flower Shop)
- TM Bullet Seed (from NPC)
...
## Key Story Beats
1. **Littleroot Town** — Rescue Prof. Birch, choose starter (Treecko/Torchic/Mudkip)
2. **Route 103** — First rival battle
3. **Petalburg City** — Meet Dad (Norman), Wally catches Ralts
4. **Petalburg Woods** — Team Aqua Grunt ambush, Devon Employee rescue
5. **Rustboro Gym** — Roxanne battle (6 Pokemon sandstorm team)

---

## Design Notes
- Exp Share available early on Route 103
- Pikachu with Light Ball on Route 102 is a strong early pickup
- Squirtle available on Routes 103 and 104 (Water-type coverage for Roxanne)
