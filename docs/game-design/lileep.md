...
| 16 | **Ingrain** | — | Grass | Passive recovery layer stacks with Giga Drain. Lileep becomes a sticky wall. |

### Cradily (evolves from Lileep at 40)

| Level | Move | BP | Type | Purpose |
|-------|------|----|------|---------|
| 1 | **Ingrain** | — | Grass | Carry-over from Lileep. Recovery anchoring from day one. |
