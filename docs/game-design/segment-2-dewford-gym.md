# Segment 2: Rustboro → Dewford Gym

**Route:** Rustboro City → Route 104 South (Mr. Briney's cottage) → BOAT → Route 105 (water) → Route 106 (water/beach) → Dewford Town → Granite Cave → Dewford Gym (Brawly)

**Theme:** Island adventure. Ocean sailing, deep cave exploration, martial arts dojo. A completely different feel from Segment 1's land routes and sandstorm gym.
...
**Badge:** Knuckle Badge
**Strategy:** Martial arts dojo — each Pokemon represents a different fighting style. Anti-Psychic and anti-Flying coverage built into the team.

| # | Pokemon | Level | Item | Ability | Moves | Fighting Style |
|---|---------|-------|------|---------|-------|---------------|
...
- Hitmonchan's elemental punches handle Flying types trying to sweep.
- Heracross's Megahorn punishes Psychic types (4x on Alakazam).
- Makuhita as ace — Iron Fist Mach Punch is priority, Drain Punch heals, Knock Off removes items, Bulk Up makes it unstoppable if you don't kill it fast.
- Machop's No Guard Dynamic Punch is 100% accurate + 100% confusion. Terrifying.
...
### Route 105 (water route, early)
*Surfing only — ocean between Petalburg side and Dewford*

| Pokemon | Levels | Notes |
|---------|--------|-------|
| Tentacool | 5-35 | Common surfing |
| Wingull | 10-30 | Common surfing |
| Pelipper | 25-30 | Rare surfing |

*Old Rod:* Magikarp, Tentacool
*Good Rod:* Wailmer

### Route 106 (water route + beach, Dewford approach)
*Surfing + small beach area*
...
| Pokemon | Levels | Notes |
|---------|--------|-------|
| Zubat | 9-11 | Common (4 slots) |
| Makuhita | 9-11 | Common (3 slots) — first Fighting type in the cave |
| Geodude | 9-10 | Uncommon (3 slots) |
| Abra | 10 | Rare (1 slot) |
| Meditite | 10-11 | Rare (1 slot) — meditating in the cave |
...
| Pokemon | Levels | Notes |
|---------|--------|-------|
| Zubat | 10-12 | Common (3 slots) |
| Aron | 10-12 | Common (3 slots) — deeper means more Steel |
| Sableye | 10-12 | Uncommon (3 slots) — lurking in shadows |
| Makuhita | 11-12 | Uncommon (2 slots) |
| Mawile | 11-12 | Rare (1 slot) — Steel/Fairy trap in the dark |
...
| Pokemon | Levels | Notes |
|---------|--------|-------|
| Sableye | 11-13 | Common (5 slots) — this is their domain |
| Aron | 11-13 | Uncommon (3 slots) |
| Duskull | 12-13 | Rare (2 slots) — ghostly presence in the deep |
| Mawile | 12-13 | Rare (1 slot) |
| Zubat | 11-12 | Uncommon (1 slot) |
...
| Pokemon | Levels | Notes |
|---------|--------|-------|
| Aron | 12-14 | Common (5 slots) |
| Makuhita | 12-14 | Uncommon (3 slots) |
| Sableye | 13-14 | Uncommon (2 slots) |
| Meditite | 13-14 | Rare (1 slot) |
| Beldum | 14 | Ultra-rare (1 slot) — Steven's signature Pokemon! |

---

## Key Story Beats

1. **Mr. Briney's Cottage** — Sail to Dewford (unlocks ocean travel)
2. **Dewford Town** — Small island town, Brawly's gym
3. **Granite Cave** — Deliver letter to Steven Stone. Multi-floor dungeon.
4. **Steven encounter** — Meet Steven studying rocks. He gives you TM Steel Wing.
5. **Brawly's Gym** — Martial arts dojo, 6-Pokemon fighting team
6. **Return to Mr. Briney** — Sail to Slateport (Segment 3)
...
### Granite Cave
- TBD — consider Eviolite (for pre-evolution builds), Focus Sash, or a Fighting-relevant item
